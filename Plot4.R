...
#################################################
## Create plot #4, save to file device = PNG
#################################################
...
with(hpowercon, plot(DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))

with(hpowercon, plot(DateTime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
...
with(hpowercon, plot(DateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
